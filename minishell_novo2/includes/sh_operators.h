...
error_t sh_traverse_heredocs(t_sh_node *node, int *hd);
...
void    sh_validate_builtin_direct(int (*builtin_func)(t_sh_cmd *), t_sh_cmd *cmd, t_sh_exec *exec_ctx);
...
/* sh_pipeline_ops.c */
void sh_execute_command_multiplex(t_sh_node *node, int *node_fd, t_sh_exec *executor, exec_t execution_mode);
void sh_wait_pipeline_processes(t_sh_pid *initial_pid, t_sh_exec *executor, exec_t execution_mode);
void sh_execute_pipeline(t_sh_node *node, int *node_fd, t_sh_exec *executor, exec_t execution_mode);
